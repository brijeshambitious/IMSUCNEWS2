...
public class Config {
    ...
    public static final Object[] TITLES = new Object[]{"News", "Notices ", "Events", "Gallery","Flip Classes" ,"ERP(Students)", "ERP(Faculty)"};
    //The URL's of your web items
    public static final String[] URLS = new String[]{"http://imsuc.ac.in/more_news.php", "http://imsuc.ac.in/notices.php", "http://imsuc.ac.in/more_event.php", "http://imsuc.ac.in/gallery.php", "http://www.imsuc.ac.in/flp/", "http://54.169.231.245/","http://54.169.231.245/admin"};
